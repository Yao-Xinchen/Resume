...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Zhejiang University - University of Illinois Urbana-Champaign Institute (ZJUI)}
        \end{twocolentry}
    ...
    \section{Technical Skills}
        ...
        \begin{onecolentry}
            \textbf{Programming Languages:} Python, C/C++, CUDA, Matlab, Rust
            ...
            \textbf{Control Theory:} PID, LQR, MPC
        \end{onecolentry}
    ...
    \section{Experience}
        ...
        \begin{highlights}
            \item Motivating emergent behaviors in locomotion controllers for bipedal robots and humanoids, using Isaac Lab and Genesis simulation platforms with custom RSL-RL implementations.
            ...
            \item Developing algorithms based on PPO and APG, which can realize higher sample efficiency and stability.
        \end{highlights}
        ...
        \begin{highlights}
            \item Built a dynamics model in Genesis simulator for ballbot PURE Gen3 platform, which aims to accurately simulate the omniwheels while presevering computational efficiency.
            ...
            \item Integrated new force sensors into PURE Gen3 hardware, improving reliablility of existing model-based controller.
        \end{highlights}
        ...
        \begin{highlights}
            ...
            \item Implemented software and hardware for real-time motor control and sensor data acquisition through their protocols, as well as high-level autonomous navigation and decision-making algorithms.
    ...
    \section{Projects}
        ...
        \begin{highlights}
            \item Overview: A novel reinforcement learning algorithm combining Proximal Policy Optimization (PPO) with Adaptive Policy Gradient (APG) mechanisms to dynamically allocate learning focus across state-action spaces.
            \item My contribution: Implemented the algorithm in PyTorch, conducted training experiments in Isaac Lab and MuJoCo environments, performed hyperparameter tuning, and deployed trained policies on simulated and real robot platforms. Contributed to experimental design and ablation studies.
        ...
        \vspace{0.10 cm}
        \begin{highlights}
            \item Overview: A reinforcement learning framework to generate emergent omnidirectional gaits for wheeled bipedal robots, enabling smooth transitions between forward, lateral, and rotational motions without explicit gait planning.
            \item My contribution: Designed the reward shaping scheme and training curriculum, implemented the simulation environment in Isaac Lab with accurate wheel-ground contact modeling, trained PPO policies with domain randomization, and conducted sim-to-real transfer experiments on a custom wheeled bipedal platform.
        ...
        \begin{twocolentry}{
            ...
            \textbf{Meta-Team/Meta-ROS: Modular ROS2 Control Framework}
        \end{twocolentry}

        \vspace{0.10 cm}
        \begin{highlights}
            \item Overview: A comprehensive ROS2-based control system architecture encompassing sensor integration, actuator control, forward/inverse kinematics, and autonomous decision-making modules for multi-robot coordination.
            \item Features: Supports heterogeneous robot platforms with dynamically configurable parameters, modular package structure for easy extension, and real-time performance optimization for competition scenarios.
