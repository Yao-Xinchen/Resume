...
\footnotelayout{m} % make footnotes appear at bottom of page instead of column
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\href{https://yao-xinchen.github.io}{\textbf{https://yao-xinchen.github.io}}}%
    \end{header}
    ...
    \section{Awards and Honors}
        ...
        \begin{highlights}
            ...
            \item Second Prize in RoboMaster\footnote{https://www.robomaster.com/en-US} University League Competition (2023, 2024)
        \end{highlights}
    ...
    \section{Experience}
        ...
        \begin{twocolentry} {
            ...
            \textbf{Physical Intelligence Lab}\footnote{https://physicalintelligence-lab.github.io/}, Zhejiang, China
            ...
            Advisor: \textbf{Prof. Hua Chen}\footnote{https://zjui.intl.zju.edu.cn/en/team/teacherinfo/2461}
        \end{twocolentry}

        \vspace{0.10 cm}

        \begin{highlights}
            \item Developing locomotion controllers for bipedal robots and humanoids using reinforcement learning.
        ...
        \begin{twocolentry} {
            ...
            \textbf{Human Dynamics and Controls Lab}\footnote{https://hdcl.mechanical.illinois.edu}, Illinois, US
            ...
            Advisor: \textbf{Prof. Elizabeth Hsiao-Wecksler}\footnote{https://bioengineering.illinois.edu/people/ethw}
        ...
        \begin{twocolentry}{
            ...
            \textbf{RoboMaster Meta Team}\footnote{https://github.com/Meta-Team}, Zhejiang, China
            ...
            Advisor: \textbf{Prof. Jiahuang Cui}\footnote{https://mechse.illinois.edu/people/profile/zjui-cui}
        ...
        \begin{highlights}
            \item Led control group to win second prize in RoboMaster University League competition, managing a team developing software for multiple competitive robots.
            ...
            \item Developed software for motor control, sensor integration, autonomous navigation, and decision algorithms.
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Where to Learn: Analytical Policy Gradient Directed Exploration for On-Policy Robotic Reinforcement Learning} (under review by IEEE RA-L)
        ...
        \begin{highlights}
            \item Implemented a novel reinforcement learning algorithm in Brax that enhances exploration efficiency and training stability for robotic control.
            \item Evaluated the algorithm in Mujoco Playground across multiple benchmark environments with comprehensive hyperparameter tuning and ablation studies.
            \item Successfully trained and deployed a walking policy on a physical biped robot for real-world validation.
            \item Website: \href{https://wheretolearn.github.io/}{https://wheretolearn.github.io}
        \end{highlights}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Omni WBR: Learning Adaptive Hybrid Wheeled-Biped Robot Omnidirectional Locomotion via Position-Based Incentive} (in progress)
        \end{twocolentry}

        \vspace{0.10 cm}
        \begin{highlights}
            \item Developed a task design to generate adaptive omnidirectional gaits for wheeled bipedal robots, enabling smooth movement on uneven terrains without explicit gait planning.
            \item Implemented a training and deploying pipeline to evaluate the method in Isaac Lab simulator and physical robot.
            \item Demonstration available on my website: \href{https://yao-xinchen.github.io/projects/omni-wbr/}{https://yao-xinchen.github.io/projects/omni-wbr}
        \end{highlights}
        ...
        \begin{highlights}
            \item Created a comprehensive robot control system in ROS2 supporting multiple competitive robots with sensor integration, motion control, and autonomous coordination.
            ...
            \item Code: \href{https://github.com/Meta-Team/Meta-ROS}{https://github.com/Meta-Team/Meta-ROS}
        \end{highlights}
        ...
        \begin{highlights}
            ...
            \item Demonstration available on my website: \href{https://yao-xinchen.github.io/projects/wheeled-biped}{https://yao-xinchen.github.io/projects/wheeled-biped}
        \end{highlights}
    ...
    \section{Course Projects}
        ...
        \begin{highlights}
            ...
            \item Composed a tutorial on workflow setup: \href{https://github.com/Yao-Xinchen/ECE391-Workflow}{https://github.com/Yao-Xinchen/ECE391-Workflow}
        \end{highlights}
        ...
        \begin{highlights}
            ...
            \item Demonstration available on my website: \href{https://yao-xinchen.github.io/projects/auto-parking/}{https://yao-xinchen.github.io/projects/auto-parking}
        \end{highlights}
\end{document}