...
\begin{document}
    ...
    \section{Education}
        ...
        \textit{Ph.D. Program (Starting September 2026):}

        \vspace{0.1cm}

        \begin{adjustwidth}{0.3cm}{}
        \begin{twocolentry}{
            Sep 2026 -- Expected 2030
        }
            \textbf{The Chinese University of Hong Kong}, Hong Kong, China\\
            Ph.D. in Mechanical and Automation Engineering\\
            Advisor: \textbf{Prof. Zhongyu Li}
        \end{twocolentry}
        \end{adjustwidth}

        \vspace{0.2 cm}

        \textit{Dual-Degree Bachelor Program:}
    ...
    \section{Publications}
        ...
        \begin{onecolentry}
            \textbf{Where to Learn: Analytical Policy Gradient Directed Exploration for On-Policy Robotic Reinforcement Learning} \href{https://wheretolearn.github.io/}{[wheretolearn.github.io]}
        \end{onecolentry}

        \begin{twocolentry}{--- \textit{IEEE RA-L, June 2026}}
            Leixin Chang, \underline{Xinchen Yao}, Ben Liu, Liangjing Yang, Hua Chen
        \end{twocolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{World Translation: Minimizing Sim-to-Real Gap with Backward Dynamics Extraction and Unpaired Domain Translation}
        \end{onecolentry}

        \begin{twocolentry}{--- \textit{IEEE RA-L (In preparation)}}
            \underline{Xinchen Yao}, Leixin Chang, Hua Chen
        \end{twocolentry}
    ...
    \section{Experience}
        ...
        \begin{highlights}
            \item Developed locomotion controllers for bipedal robots and humanoids using reinforcement learning, achieving emergent behaviors that adapt to various terrains and conditions.
            \item Built evaluation pipelines to test trained robot policies across multiple simulation environments and deployed them to physical robots.
            \item Researched methods to reduce the performance gap between simulated and real-world robot operation through learned dynamics models.
            \item Improved reinforcement learning algorithms to achieve better training efficiency and performance stability.
        \end{highlights}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Custom Wheeled Biped Robot with RL-based Locomotion Controller}
        \end{twocolentry}
