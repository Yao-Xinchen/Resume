...
\begin{document}
    ...
    \section{Awards and Honors}
        ...
        \begin{highlights}
            ...
            \item Second Prize in \href{https://www.robomaster.com/en-US}{RoboMaster} University League Competition (2023, 2024)
        \end{highlights}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{World Translation: Minimizing Sim-to-Real Gap with Backward Dynamics Extraction and Unpaired Domain Translation (Under review at RSS 2026)}
        \end{twocolentry}

        \vspace{0.10 cm}

        \begin{highlights}
            \item Identified complementary strengths of simulators (modeling transient physics) and learned models (capturing domain characteristics), and combined them through a unified framework.
            \item Proposed backward dynamics extraction to infer effects of hidden variables (unobservable factors like contacts, collisions, and disturbances) from transition outcomes, eliminating temporal smoothness assumptions of conventional learned dynamics models that fail under discontinuous changes.
            \item Reformulated sim-to-real transfer as unpaired domain translation, preserving hidden variable semantics while correcting domain mismatch without paired supervision.
            \item Demonstrated improved dynamics modeling on humanoid, quadruped, and manipulator platforms. Validated on downstream policy performance boost on real robots.
        \end{highlights}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Where to Learn: Analytical Policy Gradient Directed Exploration for On-Policy Robotic Reinforcement Learning (Under review at RA-L)}
        ...
        \begin{highlights}
            \item Co-designed and built a custom wheeled biped robot with 4 degrees of freedom and closed chain structure, including low-level control system on embedded platform.
